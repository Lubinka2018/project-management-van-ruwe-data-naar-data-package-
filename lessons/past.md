...
1. If you are prompted to sign in to GitHub, please do so.
...
1. In Github Desktop, click on `Publish repository`. If you are prompted to `Sign in` to GitHub, please do so.
